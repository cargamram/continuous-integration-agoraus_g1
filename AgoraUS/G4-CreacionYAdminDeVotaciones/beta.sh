...
URL_VIRTUAL_HOST="beta.cavotacion.agoraus1.egc.duckdns.org"
BRANCH="beta"
PROJECT_JENKINS_NAME="AgoraUS-G4-CreacionYAdminDeVotaciones_make"

PATH_ROOT="/var/jenkins_home"
PATH_ROOT_HOST="/home/egcuser/jenkins_home"

CONF_TOMCAT_SERVER="$PATH_ROOT_HOST/continuous-delivery-playground/AgoraUS/G4-CreacionYAdminDeVotaciones/beta-conf/tomcat7/server.xml"
...
docker exec $ENV_NAME-$BRANCH-mysql \
    bash -c "exec mysql -uroot -proot < /home/user/folder/scrip2.sql"
